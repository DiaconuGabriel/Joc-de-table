...
class Piesa:
    ...
    def verifica(self):
        ...
        if tura_player1==True and len(lista_n_player1)>2 and lista_n_player1[-2]<=6:
            if f==0:
                if len(muta_piesa_maro_disponibila(lista_n_player1[-2]))==0:
                    if len(muta_piesa_maro_disponibila(lista_m_player1[-2]))==0:
                        lista_n_player1[-1]=0
                        lista_m_player1[-1]=0
                    elif len(muta_piesa_maro_disponibila(lista_m_player1[-2]))>0:
                        if lista_m_player1[-1]!=0:
                            pass
                        else:
                            lista_n_player1[-1]=0
                elif len(muta_piesa_maro_disponibila(lista_n_player1[-2]))>0:
                    if len(muta_piesa_maro_disponibila(lista_m_player1[-2]))==0:
                        if lista_n_player1[-1]==0:
                            lista_m_player1[-1]=0
                    elif len(muta_piesa_maro_disponibila(lista_m_player1[-2]))>0:
                        pass
            positie=pygame.mouse.get_pos()
            if self.rect.collidepoint(positie) and self.id=='maro':
                if zar_m_selectat1==True and zar_n_selectat1==False and lista_m_player1[-1]==0:
                    if pygame.mouse.get_pressed()[0]:
                        fereastra.blit(text7,(15,750))
                if zar_n_selectat1==True and zar_m_selectat1==False and lista_n_player1[-1]==0:
                    if pygame.mouse.get_pressed()[0]:
                        fereastra.blit(text7,(15,750))
                if zar_n_selectat1==True and zar_m_selectat1==False and lista_n_player1[-1]>0:
                    if pygame.mouse.get_pressed()[0] and len(zone[0])<=0:
                        if zone[self.zona][-1].zona+val_zar_n1 > 24:
                            if self.nr_buton==zone[self.zona][-1].nr_buton:
                                if verifica_piese_maro()==True:
                                    if (25-zone[self.zona][-1].zona)==val_zar_n1:
                                        zone[-1].append(zone[self.zona][-1])
                                        zone[self.zona].remove(zone[self.zona][-1])
                                        zone[-1][-1].zona=26
                                        self.schimba_poz()
                                        lista_n_player1[-1]-=1
                                    elif (25-zone[self.zona][-1].zona)!=val_zar_n1:
                                        if verifica_piese_inainte_a_scoate_maro(zone[self.zona][-1].zona)==0:
                                            zone[-1].append(zone[self.zona][-1])
                                            zone[self.zona].remove(zone[self.zona][-1])
                                            zone[-1][-1].zona=26
                                            self.schimba_poz()
                                            lista_n_player1[-1]-=1
                                        elif verifica_piese_inainte_a_scoate_maro(zone[self.zona][-1].zona)>0:
                                            fereastra.blit(text14,(120,750))
                                elif verifica_piese_maro()==False:
                                    fereastra.blit(text4,(50,750))
                            elif self.nr_buton!=zone[self.zona][-1].nr_buton:
                                fereastra.blit(text5,(35,750))
                        elif zone[self.zona][-1].zona+val_zar_n1 <= 24:
                            if self.nr_buton==zone[self.zona][-1].nr_buton:
                                if len(zone[self.zona+val_zar_n1])==0:
                                    self.zona+=val_zar_n1
                                    lista_n_player1[-1]-=1
                                    self.schimba_poz()
                                    self.modifica_zona_n1()
                                    pygame.mouse.get_pressed()[0]==False
                                elif len(zone[self.zona+val_zar_n1])==1:
                                    if zone[self.zona+val_zar_n1][-1].id=='negru':
                                        zone[self.zona+val_zar_n1][-1].zona=25
                                        zone[self.zona+val_zar_n1][-1].schimba_poz()
                                        zone[25].append(zone[self.zona+val_zar_n1][-1])
                                        zone[self.zona+val_zar_n1].remove(zone[self.zona+val_zar_n1][-1])
                                        self.zona+=val_zar_n1
                                        lista_n_player1[-1]-=1
                                        self.schimba_poz()
                                        self.modifica_zona_n1()
                                        pygame.mouse.get_pressed()[0]==False
                                    elif zone[self.zona+val_zar_n1][-1].id=='maro':
                                        self.zona+=val_zar_n1
                                        lista_n_player1[-1]-=1
                                        self.schimba_poz()
                                        self.modifica_zona_n1()
                                        pygame.mouse.get_pressed()[0]==False
                                elif len(zone[self.zona+val_zar_n1])>=2:
                                    if zone[self.zona+val_zar_n1][-1].id=='negru':
                                        fereastra.blit(text3,(125,750))
                                    else:
                                        self.zona+=val_zar_n1
                                        lista_n_player1[-1]-=1
                                        self.schimba_poz()
                                ...
                                fereastra.blit(text5,(35,750))
                    elif pygame.mouse.get_pressed()[0] and len(zone[0])>0:
                        if self.nr_buton!=zone[0][-1].nr_buton:
                            fereastra.blit(text6,(140,750))
                        elif self.nr_buton==zone[0][-1].nr_buton:
                            if len(zone[self.zona+val_zar_n1])==0:
                                self.zona+=val_zar_n1
                                lista_n_player1[-1]-=1
                                self.schimba_poz()
                ...
                if zar_m_selectat1==True and zar_n_selectat1==False and lista_m_player1[-1]>0:
                    if pygame.mouse.get_pressed()[0] and len(zone[0])<=0:
                        if zone[self.zona][-1].zona+val_zar_m1>24:
                            if self.nr_buton==zone[self.zona][-1].nr_buton:
                                if verifica_piese_maro()==True:
                                    if (25-zone[self.zona][-1].zona)==val_zar_m1:
                                        zone[-1].append(zone[self.zona][-1])
                                        zone[self.zona].remove(zone[self.zona][-1])
                                        zone[-1][-1].zona=26
                                        self.schimba_poz()
                                        lista_m_player1[-1]-=1
                                    elif (25-zone[self.zona][-1].zona)!=val_zar_m1:
                                        if verifica_piese_inainte_a_scoate_maro(zone[self.zona][-1].zona)==0:
                                            zone[-1].append(zone[self.zona][-1])
                                            zone[self.zona].remove(zone[self.zona][-1])
                                            zone[-1][-1].zona=26
                                ...
                                fereastra.blit(text5,(35,750))
                        elif zone[self.zona][-1].zona-val_zar_m1 <= 24:
                            if self.nr_buton==zone[self.zona][-1].nr_buton: 
                                if len(zone[self.zona+val_zar_m1])==0:
                                    self.zona+=val_zar_m1
                                    lista_m_player1[-1]-=1
                                    self.schimba_poz()
                                    self.modifica_zona_m1()
                                    pygame.mouse.get_pressed()[0]==False
                                elif len(zone[self.zona+val_zar_m1])==1:
                                    if zone[self.zona+val_zar_m1][-1].id=='negru':
                                        zone[self.zona+val_zar_m1][-1].zona=25
                                        zone[self.zona+val_zar_m1][-1].schimba_poz()
                                        zone[25].append(zone[self.zona+val_zar_m1][-1])
                                        zone[self.zona+val_zar_m1].remove(zone[self.zona+val_zar_m1][-1])
                                        self.zona+=val_zar_m1
                                        lista_m_player1[-1]-=1
                                        self.schimba_poz()
                                        self.modifica_zona_m1()
                                        pygame.mouse.get_pressed()[0]==False
                                    elif zone[self.zona+val_zar_m1][-1].id=='maro':
                                        self.zona+=val_zar_m1
                                        lista_m_player1[-1]-=1
                                        self.schimba_poz()
                                        self.modifica_zona_m1()
                                        pygame.mouse.get_pressed()[0]==False
                                elif len(zone[self.zona+val_zar_m1])>=2:
                                    if zone[self.zona+val_zar_m1][-1].id=='negru':
                                        fereastra.blit(text3,(125,750))
                                    else:
                                        self.zona+=val_zar_m1
        ...
        if tura_player==True and len(lista_n_player)>1 and joc_cu_alt_player==False:
            if f==0:
    ...
    def modifica_zona_n1(self):
        if self.id=='maro':
            zone[self.zona].append(zone[self.zona-val_zar_n1][-1])
            zone[self.zona-val_zar_n1].remove(zone[self.zona-val_zar_n1][-1])
 
    def modifica_zona_m1(self):
        if self.id=='maro':
            zone[self.zona].append(zone[self.zona-val_zar_m1][-1])
            zone[self.zona-val_zar_m1].remove(zone[self.zona-val_zar_m1][-1])
...
text_player_la_mutare=font.render('Player la mutare', True, GREEN)
...
lista_n_player1=[88,88]
lista_m_player1=[88,88]
lista_n_calculator=[88,88]
lista_m_calculator=[88,88]
val_zar_n1=0
val_zar_m1=0
zar_n_selectat1=False
zar_m_selectat1=False
tura_player=True
tura_player1=False
tura_calculator=False
joc_cu_alt_player=False
...
def joaca3():
    ...
    global val_zar_n1   
    global val_zar_m1
    global zar_n_selectat1
    global zar_m_selectat1
    global joc_cu_alt_player
    global tura_player
    global f
    joc_cu_alt_player=True
    clock = pygame.time.Clock()
    client = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    client.settimeout(None)
    try:
        client.connect(('192.168.0.87', 9090))
    except:
        nu_te_poti_conecta()
    ...
    while joaca4:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYUP:
                if event.key == pygame.K_SPACE: 
                    if tura_player1==True and zar_n_selectat1==False and zar_m_selectat1==False:
                        if f==1:
                            f-=1
                            cheie_m1=False
                            cheie_n1=False
                            ...
                            if n==m:
                                lista_n_player1.append(n)
                                lista_n_player1.append(2)
                                lista_m_player1.append(m)
                                lista_m_player1.append(2)
                            if n!=m:
                                lista_n_player1.append(n)
                                lista_n_player1.append(1)
                                lista_m_player1.append(m)
                                lista_m_player1.append(1)
                        tura_player=False
                        da_cu_zarul=False
 
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_n and tura_player1==True:
                    if lista_n_player1[-2]<=6 and lista_n_player1[-2]>0 and f==0:
                        val_zar_n1=lista_n_player1[-2]
                        cheie_n1=True
                        cheie_m1=False
                        zar_n_selectat1=True
                        zar_m_selectat1=False
                    else:
                        da_cu_zarul=True
                if event.key == pygame.K_m and tura_player1==True:
                    if lista_m_player1[-2]<=6 and lista_m_player1[-2]>0 and f==0:
                        val_zar_m1=lista_m_player1[-2]
                        cheie_n1=False
                        cheie_m1=True
                        zar_n_selectat1=False
                        zar_m_selectat1=True
                    else:
                        da_cu_zarul=True
        ...
        if tura_player1==False:
            zaruri[n-1].draw(1000,362)
            zaruri[m-1].draw(1000,406)
            fereastra.blit(text_player_la_mutare,(650,750))

        if tura_player1==True:
            zaruri[n-1].draw(1000,245)
            zaruri[m-1].draw(1000,290)
            if cheie_n1==True:
                pygame.draw.rect(fereastra,GREEN,(998,243,40,40),4)
            elif cheie_m1==True:
                pygame.draw.rect(fereastra,GREEN,(998,288,40,40),4)
            if da_cu_zarul==True:
                fereastra.blit(text8,(170,750)) 
        ...
        if lista_n_player1[-1]==0 and lista_m_player1[-1]==0:
            tura_player=True
            tura_player1=False
            cheie_n1=False
            cheie_m1=False
            ...
            lista_m_player1[-1]=-1
            lista_n_player1[-1]=-1
            date=[tura_player,tura_player1,dictionar1,n,m]
            serialized_data = pickle.dumps(date)
            client.sendall(serialized_data)
